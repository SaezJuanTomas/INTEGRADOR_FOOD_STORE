# app/modules/payments/models.py — Modelo de datos para pagos
#
# Este modelo almacena TODA la información relevante de un pago, incluyendo
# los datos que vienen y van hacia MercadoPago. Cada registro representa un
# intento de pago para un pedido, y puede pasar por los estados:
#   pendiente -> aprobado | rechazado
#
# FLUJO COMPLETO DE UN PAGO CON MERCADOPAGO:
#   1. El frontend pide crear un pago → se crea una "preferencia" en MP
#   2. MP devuelve un preference_id y un init_point (URL de checkout)
#   3. El frontend redirige al usuario a MP checkout
#   4. El usuario paga (o no) en MP
#   5. MP nos notifica via webhook con los datos del pago real
#   6. Consultamos el payment_id a MP para obtener el estado real
#   7. Actualizamos nuestra BD con el resultado
#
